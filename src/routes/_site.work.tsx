      ...
      <section className="pt-44 pb-16 px-6 sm:px-10">
        <div className="max-w-[1600px] mx-auto">
          ...
          <p className="max-w-2xl text-lg text-foreground/70 animate-reveal" style={{ animationDelay: "0.2s" }}>
            Selected work across identity, web, and interactive. Click any project to read the case study, see the metrics, and watch the launch reel.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-px">
              {projects.map((p, i) => (
                <Reveal key={p.slug} delay={i * 40}>
                  <div className="group grid grid-cols-12 gap-4 items-center py-8 border-t border-border hover:bg-card transition-colors px-4 -mx-4 rounded-md">
